...
// create a new instance of Services_JSON (PEAR pack)
        ...
        $data = $json_PEAR->decode($data['body']);
...
// create a new instance of Services_JSON (PEAR pack)
        $json_PEAR = new Services_JSON(SERVICES_JSON_LOOSE_TYPE);
...
//        return json_decode($response['body'],true);
// My settings
        return $json_PEAR->decode($response['body']);
